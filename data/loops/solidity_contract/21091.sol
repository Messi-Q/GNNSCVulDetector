...
interface TokenInterface {
 ...
 contract DayDayCrowdsale is Ownable{
  ...
  uint256 minimumContributionPrivate = 10 * 10 ** 18;  
  uint256 maximumContributionPrivate = 200 * 10 ** 18;  
  
  uint256 minimumContributionPublic = 1 * 10 ** 18;  
  uint256 maximumContributionPublic = 10 * 10 ** 18;  
