...
contract MeepleCoin is ERC20
{ using SafeMath for uint256;
     
    string public constant name = "MeepleCoin";

     
    string public constant symbol = "MPL";
    uint8 public constant decimals = 18;
    uint public _totalsupply = 129500000 * 10 ** 18;  
    address public owner;                     
    uint256 public _price_tokn_PRE = 3800;   
    uint256 public _price_tokn_ICO= 2400;    
    ...
    uint256 maxCap_public = 77700000 * 10 **18;   
    ...
    function MeepleCoin() public
    {
        owner = msg.sender;
        balances[owner] = 51800000 * 10 **18;  
