...
contract LotteryRecharge
{
    ...
    uint256 public nPlatCurTotalEth;             
    uint256 public constant nCanOpenRewardMinEth = 10 ether;
    uint256 private constant leastRecharge = 0.1 ether;           
    uint256 private constant OpenRewardClockSeconds = 1*3600;     
    uint256 private constant MaxClockSeconds = 24*3600;           
